    ...
    <form id="formLayoutSectores" runat="server">
                                ...
                                <asp:Repeater ID="rptSectores" runat="server" OnItemCommand="rptSectores_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Eval("Superficie") %> m2;</td>
                                            <td><%# Eval("CantidadProductos") %></td>
                                            <td><%# Eval("Posicion") %></td>
                                            <td><span class="ls-color-muestra" style='<%# "background-color:" + Eval("Color") %>'></span></td>
                                            <td>
        ...
        <asp:Panel ID="pnlModalSector" runat="server" ClientIDMode="Static" CssClass="modal-fondo" Style="display: none;">
            <div class="modal-caja">
                ...
                <div class="fila-formulario">
                    <div class="grupo-campo">
                        <asp:Label runat="server" Text="Superficie (m2)" AssociatedControlID="tbSuperficieSector" />
                        <asp:TextBox ID="tbSuperficieSector" runat="server" CssClass="modal-campo" TextMode="Number" />
                    </div>
                    <div class="grupo-campo">
                        <asp:Label runat="server" Text="Posición" AssociatedControlID="ddlPosicionSector" />
                        <asp:DropDownList ID="ddlPosicionSector" runat="server" CssClass="modal-campo">
                ...
                <div class="grupo-campo">
                    <asp:Label runat="server" Text="Color identificador" AssociatedControlID="tbColorSector" />
                    <asp:TextBox ID="tbColorSector" runat="server" CssClass="modal-campo" TextMode="Color" Text="#6a7cf0" />
                </div>
